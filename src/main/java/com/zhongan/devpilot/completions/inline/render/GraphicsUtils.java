...
public class GraphicsUtils {
    ...
    public static Color niceContrastColor() {
        ...
        for(double minBrightness = getBrightness(Color.darkGray); currentBrightness > minBrightness; currentBrightness = getBrightness(currentResult)) {
    ...
    private static double getBrightness(Color color) {
        return Math.sqrt((double)(color.getRed() * color.getRed()) * 0.241 + (double)(color.getGreen() * color.getGreen()) * 0.691 + (double)(color.getBlue() * color.getBlue()) * 0.068);
    }
