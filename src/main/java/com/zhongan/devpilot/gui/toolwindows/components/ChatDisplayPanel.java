...
public class ChatDisplayPanel extends JPanel {
    ...
    static class Title extends JPanel {
        ...
        private JBLabel userLabel() {
            return new JBLabel(DevPilotLlmSettingsState.getInstance().getFullName(), DevPilotIcons.USER_ICON, SwingConstants.LEADING)
                .setAllowAutoWrapping(true)
                .withFont(JBFont.label().asBold());
        }

        private JBLabel systemLabel() {
            return new JBLabel("DevPilot", DevPilotIcons.SYSTEM_ICON, SwingConstants.LEADING)
                .setAllowAutoWrapping(true)
                .withFont(JBFont.label().asBold());
        }
