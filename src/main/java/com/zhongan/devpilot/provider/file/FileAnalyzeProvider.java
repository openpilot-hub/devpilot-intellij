...
public interface FileAnalyzeProvider {
    ...
    default void buildRelatedContextDataMap(Project project, CodeReferenceModel codeReference, List<PsiElement> localRef, List<String> remoteRef, Map<String, String> data) {
    }
